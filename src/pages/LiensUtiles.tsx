      ...
      <div className="container mx-auto px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold">Liens Utiles</h2>
          </div>
          ...
          <div className="relative max-w-sm sm:max-w-md">
            ...
            <Input placeholder="Rechercher un site..." className="pl-10 text-sm sm:text-base w-full" />
          </div>
        </div>
        ...
        {/* Call to Action */}
        <Card className="bg-primary/5 border-primary/20 mt-8 sm:mt-12">
          <CardHeader className="text-center">
            <CardTitle className="text-lg sm:text-xl">Suggérer un lien</CardTitle>
