    ...
    <main className="flex-1">
      ...
      <div className="bg-muted/30 py-2">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-foreground">Médiathèque</span>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">Médiathèque</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explorez notre collection de vidéos, podcasts et témoignages pour mieux comprendre vos droits.
          </p>
        </div>
        ...
        <div className="mb-8 animate-fade-in">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="text-sm font-medium text-muted-foreground mr-2">Types:</span>
            {types.map((type) => (
              <Button
                key={type}
        ...
        {selectedCategory === "Tous" && selectedType === "Tous" && (
          <div className="mb-12 animate-fade-in">
            <h2 className="text-2xl font-semibold mb-6">Contenu à la une</h2>
        ...
        <div className="mb-12 animate-fade-in">
          <h2 className="text-2xl font-semibold mb-6">
            {selectedCategory === "Tous" && selectedType === "Tous" 
              ? "Tous les contenus" 
              : `Contenus ${selectedCategory !== "Tous" ? selectedCategory : ""} ${selectedType !== "Tous" ? selectedType : ""}`}
          </h2>
        ...
        <div className="bg-muted/50 rounded-lg p-6 text-center animate-fade-in">
          <h3 className="text-xl font-semibold mb-2">Partagez votre expérience</h3>
          <p className="text-muted-foreground mb-4">
            Vous avez une histoire à raconter ? Aidez d'autres citoyens en partageant votre témoignage.
          </p>
          <Button>
