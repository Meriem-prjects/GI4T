...
import { Pen, Calendar, User } from "lucide-react";
...
const Commentaires = () => {
  ...
  const { data: documents, isLoading } = useDocumentsByType('Commentaires');
      ...
      <div className={`mb-6 w-full flex justify-start`}>
        <Breadcrumb>
          <BreadcrumbList className={isRTL ? 'flex-row-reverse' : ''}>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{t('opinionArticles')}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
