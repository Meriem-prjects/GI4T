...
const CarteInteractiveNav = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: MapPin,
      description: t('locateServices')
    },
    {
      path: "/acces-aux-droits/adresses-utiles",
      label: t('usefulAddresses'),
      icon: Building,
      description: t('organizationsContacts')
    }
  ];
...
export default CarteInteractiveNav;
