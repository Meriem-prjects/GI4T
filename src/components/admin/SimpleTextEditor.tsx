...
import { sanitizeArabicTextFrontend, isArabicText, getTextDirection } from '@/lib/arabicUtils';
...
const SimpleTextEditor: React.FC<SimpleTextEditorProps> = ({
  ...
  const insertFormatting = (prefix: string, suffix: string = '') => {
    ...
    onChange(sanitizeArabicTextFrontend(newContent));
    ...
    <div className={`border rounded-lg ${className}`}>
      ...
      <div className="bg-background">
        <Textarea
          ref={textareaRef}
          value={content}
          onChange={(e) => onChange(sanitizeArabicTextFrontend(e.target.value))}
