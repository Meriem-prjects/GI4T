  ...
  return <footer className="bg-slate-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 ${isRTL ? 'text-right' : ''}`}>
          ...
          <div className={`space-y-4 text-center ${isRTL ? 'font-almarai md:order-2' : ''}`}>
          ...
          <div className={`space-y-4 ${isRTL ? 'md:order-1' : ''}`}>
            <h3 className={`text-lg font-semibold text-white ${isRTL ? 'font-almarai text-right' : ''}`}>{t('stayInformed')}</h3>
