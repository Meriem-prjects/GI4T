  ...
  return (
    <header className="bg-white border-b border-border shadow-sm">
      <div className="container mx-auto px-4">
        ...
        <div className={`flex items-center justify-center py-4 relative ${isRTL ? 'flex-row-reverse' : ''}`}>
          <div className="text-center">
            ...
            <p className={`text-primary text-xs font-medium hidden sm:block ${isRTL ? 'font-almarai' : ''}`}>
              {t('tagline')}
            </p>
          </div>
        ...
        <nav className="border-t border-border">
          <div className="flex items-center justify-center py-3">
            <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-6 flex-row-reverse' : 'space-x-6'}`}>
              <Link to="/information/qui-sommes-nous">
                <Button variant="ghost" className={`text-sm ${isRTL ? 'font-almarai' : ''}`}>
                  {t('whoWeAre')}
                </Button>
              </Link>
