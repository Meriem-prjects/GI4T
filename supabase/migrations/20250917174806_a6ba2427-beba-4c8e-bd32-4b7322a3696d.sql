-- Clear existing document types and categories
DELETE FROM document_types;
DELETE FROM categories;

-- Insert the two specific document types
INSERT INTO document_types (name, name_ar, description, description_ar) VALUES
('Fiche de jurisprudence', 'بطاقة فقه القضاء', 'Document relatif aux décisions de justice et à la jurisprudence', 'وثيقة تتعلق بقرارات المحكمة والسوابق القضائية'),
('Document d''analyse juridique', 'وثيقة تحليل قانوني', 'Document d''analyse et d''étude juridique', 'وثيقة تحليل ودراسة قانونية');
